...
class Agree
{
  public:
     ...
     */
    explicit Agree(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Agree(const Json::Value &pJson) noexcept(false);
     ...
     */
    Agree(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column Agree_ID  */
    ///Get the value of the column Agree_ID, returns the default value if the column is null
    const int32_t &getValueOfAgreeId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getAgreeId() const noexcept;
    ///Set the value of the column Agree_ID
    void setAgreeId(const int32_t &pAgreeId) noexcept;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where Agree_ID = ?";
        return sql;                   
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where Agree_ID = ?";
        return sql;                   
    }
