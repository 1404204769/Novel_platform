...
namespace User
{
  ...
  public:
    ...
    METHOD_ADD(Note::LikeSearch, "/Like/Search", Get, Post, Options, "MyJsonFilter", "JwtFilter", "LoginFilter");
    ...
    void LikeSearch(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback) const;
