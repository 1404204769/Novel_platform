...
class Resource:public drogon::HttpController<Resource>
{
  public:
    METHOD_LIST_BEGIN
      ...
      METHOD_ADD(Resource::UploadLN,"/Upload/List/New",Get,Post,Options,"MyJsonFilter","JwtFilter","LoginFilter");
      METHOD_ADD(Resource::UploadLO,"/Upload/List/Old",Get,Post,Options,"MyJsonFilter","JwtFilter","LoginFilter");
    METHOD_LIST_END
    ...
    void UploadLN(const HttpRequestPtr &req,std::function<void (const HttpResponsePtr &)> &&callback) const;
    void UploadLO(const HttpRequestPtr &req,std::function<void (const HttpResponsePtr &)> &&callback) const;
};
}
